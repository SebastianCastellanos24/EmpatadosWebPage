        ...
        <>
            ...
            <section className='bg-[#C8E6E4] py-6'>
                <div className='flex items-center justify-center max-w-[1200px] mx-auto my-6 md:my-8'>
                    <div className='w-1/2'>
                        <Link to={"/enlazados"}>
                            <img src={EnlazadosLogo} alt='logo enlazados ' className='w-56 md:w-72 lg:w-96 m-auto hover:scale-110 mt-6 md:mt-0'/>
                        </Link>
                    </div>
                    <div className='w-1/2'>
                        <Link to={"/mividamiproyecto"}>
                            <img src={MiVidaLogo} alt='logo mi vida, mi pryecto' className='w-36 md:w-48 lg:w-72 m-auto hover:scale-110'/>
                        </Link>
                    </div>
                </div>
            </section>
