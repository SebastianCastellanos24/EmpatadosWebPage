...
export const Empatate = () => {
    ...
    return (
        <>
            <header>
                <div className='gif'>
                    <img src={HomeGif} alt='logo empatados' className='w-full h-[400px] md:h-[500px] lg:h-[800px]'/>
                </div>
            </header>
            ...
            <section className='my-5'>
                <img src={Donacion} alt='logo empatados' className='w-full h-[400px] md:h-[600px] lg:h-[800px]'/>
            </section>
